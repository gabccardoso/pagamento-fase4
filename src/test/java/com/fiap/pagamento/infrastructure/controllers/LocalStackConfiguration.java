...
public class LocalStackConfiguration {
    ...
    public void init() {
        ...
        CreateTableRequest tablePaymentRequest = dynamoDBMapper
                .generateCreateTableRequest(PaymentEntity.class);
        tablePaymentRequest.setProvisionedThroughput(
                new ProvisionedThroughput(1L, 1L));
        amazonDynamoDB.createTable(tablePaymentRequest);
    }
}